...
public class SetApprovalStatusRequest extends BulkEditRequest {
  ...
  public AppResponse execute() throws Exception {
    /*
     * http://localhost:8080/geoportal/rest/metadata/setApprovalStatus?id=
     * 68e65338e166458d8425775114487b31&approvalStatus=draft
     * 
     * approvalStatus=
     */
    ...
    if (!status.equals("approved") && !status.equals("reviewed") && !status.equals("disapproved")
        && !status.equals("incomplete") && !status.equals("posted") && !status.equals("draft")
        && !status.equals("active") && !status.equals("inactive")) {
      String msg =
          "approvalStatus must be approved, reviewed, disapproved, incomplete, posted, draft, active or inactive";
