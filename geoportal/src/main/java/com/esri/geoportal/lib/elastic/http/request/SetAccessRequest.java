...
public class SetAccessRequest extends BulkEditRequest {
  ...
  public AppResponse execute() throws Exception {
    /*
     * http://localhost:8080/geoportal/rest/metadata/setAccess?id=68e65338e166458d8425775114487b31&
     * access=private&group=g1&group=g2
     * 
     * access=&group=&group=
     */
    ...
    /*
     * // TODO should this be enforced? if (access.equals("public") && hasGroups) { String msg =
     * "access must be private when groups are specified";
     * response.writeBadRequest(this,JsonUtil.newErrorResponse(msg,getPretty())); return response; }
     */
