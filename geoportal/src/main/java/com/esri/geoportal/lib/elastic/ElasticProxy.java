...
public class ElasticProxy extends BalancerServlet {
   ...
   * 
   * @Override protected String filterServerResponseHeader(HttpServletRequest request, Response
   * serverResponse, String headerName, String headerValue) { return
   * super.filterServerResponseHeader(request, serverResponse, headerName, headerValue); }
   */
  ...
  protected HttpClient newHttpClient() {
    ...
    if (proxyBufferSize != null) {
      LOGGER.debug("Buffer size for HTTP client for ElasticProxy set to: {} bytes",
          proxyBufferSize);
