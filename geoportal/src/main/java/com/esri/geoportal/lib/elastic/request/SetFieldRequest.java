...
public class SetFieldRequest extends BulkEditRequest {
  ...
  public AppResponse execute() throws Exception {
    /*
     * http://localhost:8080/geoportal/rest/metadata/setField?id=68e65338e166458d8425775114487b31&
     * field=myField&value=myValue
     * 
     * field=value=
     */
    ...
    /*
     * String prop = "user_tags_s"; String v = "blue"; String src =
     * "ctx._source."+prop+".add(params.value)"; HashMap<String,Object> params = new
     * HashMap<String,Object>(); params.put("value",v); Script script = new
     * Script(ScriptType.INLINE,"painless",src,params); this.setUpdateScript(script);
     */
