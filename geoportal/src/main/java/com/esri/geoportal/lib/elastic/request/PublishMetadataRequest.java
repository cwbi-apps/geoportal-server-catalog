...
public class PublishMetadataRequest extends AppRequest {
  ...
  protected void prePublish(ElasticContext ec, AccessUtil au, AppResponse response,
      MetadataDocument mdoc) throws Exception {
    ...
    // }
    // if (owner_s == null || owner_s.length() == 0 || owner_txt == null || owner_txt.length() == 0)
    // setOwner = true;
    // }
    // if (setOwner) {
    // if (username == null) {
   ...
   * @throws Exception
   */
  protected void wasXmlModified(ElasticContext ec, MetadataDocument mdoc,
      Map<String, Object> elasticSource, String now, JsonObjectBuilder jb) throws Exception {
    // ItemIO itemio = new ItemIO();
