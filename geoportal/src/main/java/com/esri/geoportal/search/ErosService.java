...
public class ErosService extends Application {
  ...
  @GET
  public void get(@Suspended final AsyncResponse asyncResponse, @Context SecurityContext sc,
  ...
  public void post(@Suspended final AsyncResponse asyncResponse, @Context SecurityContext sc,
  ...
  public void postString(@Suspended final AsyncResponse asyncResponse, @Context SecurityContext sc,
  ...
  public void getDescription(@Suspended final AsyncResponse asyncResponse,
      @Context SecurityContext sc, @Context HttpServletRequest hsr) {
    AppUser user = new AppUser(hsr, sc);
    new SearchRequest(asyncResponse, user).execute(hsr);
  }
