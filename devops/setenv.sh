...
export keycloakTokenUrl=https://dev2.crrel.mil/realms/cwbi/protocol/openid-connect/token
export keycloakAuthUrl=https://dev2.crrel.mil/auth/realms/cwbi/protocol/openid-connect/auth
